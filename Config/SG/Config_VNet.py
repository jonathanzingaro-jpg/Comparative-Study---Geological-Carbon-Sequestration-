...
Model_Config = {
    ...
    "Model_Type": "V-Net",                    # Options: ['FNO', 'U-FNO', 'U-Net', 'CNN']
    "N_Epoch": 750,                        # Number of Epochs
    "Model_Name": "V-Net (SG Full Dataset with dSG Term = 0.01)",      # Name of Model -> Base Folder Name used to Save Model and Results
