...
Model_Config = {
    ...
    "Model_Name": "U-FNO (SG Full Dataset with dSG Term = 0.01)",      # Name of Model -> Base Folder Name used to Save Model and Results
...
Toggle_Config = {
    ...
    "Plot_Rate": 25,                       # Number of Epochs for Plotting
