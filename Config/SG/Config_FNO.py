...
Description:
    ...
    optimizer, scheduler, and training settings for the FNO
...
Model_Config = {
    ...
    "Model_Type": "FNO",                                        # Options: ['FNO', 'U-FNO', 'U-Net', 'CNN']
    "N_Epoch": 350,                                             # Number of Epochs
    "Model_Name": "FNO (SG Full Dataset with dSG Term = 0.01)",      # Name of Model -> Base Folder Name used to Save Model and Results
