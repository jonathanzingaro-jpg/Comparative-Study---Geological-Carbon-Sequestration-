...
Description:
    ...
    optimizer, scheduler, and training settings for the Temporal CNN
    applied to the Wen et al. (2022) Saturation Equation dataset.
...
Model_Config = {
    ...
    "Model_Type": "CNN",                    # Options: ['FNO', 'U-FNO', 'U-Net', 'CNN']
    "N_Epoch": 750,                        # Number of Epochs
    "Model_Name": "CNN (SG Full Dataset with dSG Term = 0.01)",  # Name of Model -> Base Folder Name used to Save Model and Results
    "Problem_Type": "SG",                   # Type of Model -> Options: ["dP", "SG"]
...
# ============================================================
Dataset_Config = {
    "Dataset_Name_Inputs": "SG_Raw_Inputs.pt",
    "Dataset_Name_Outputs": "SG_Raw_Outputs.pt",    
    "Batch_Size": 10,
    "Load_Data": True
}
